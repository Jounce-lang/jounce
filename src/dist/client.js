...
export function Timer({} = {}) {
  ...
  onDestroy(() => { console.log("Timer destroyed!") });
  return h('div', null, h('h1', null, "Count:", (() => { const __reactive = signal(""); effect(() => { __reactive.value = count.value; }); return __reactive; })()), h('button', { onClick: () => { count.value = (count.value + 1); } }, "Increment"));

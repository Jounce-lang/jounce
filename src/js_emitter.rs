...
impl JSEmitter {
    ...
    pub fn generate_client_js(&self) -> String {
        ...
        // Import runtime (Session 18: Added lifecycle hooks)
        output.push_str("import { h, RPCClient, mountComponent, navigate, getRouter, onMount, onUnmount, onUpdate } from './client-runtime.js';\n");

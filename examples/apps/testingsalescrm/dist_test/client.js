...
export function main() {
  return console.log("Simple Test - Starting...");
...
export function SimpleTest({} = {}) {
  let count = signal(42);
  return h('div', null, h('h1', null, "Count:", (() => { const __reactive = signal(""); effect(() => { __reactive.value = count.value; }); return __reactive; })()));
